...
const UserOrderHistory = () => {
  ...
  return (
    <>
    {!orderHistory && <div className='flex items-center justify-center h-[100%]cd'><Loader/></div>}
  ...
  <div className='h[100%] p-0 md:p-4 text-zinc-100 '>
    ...
    {orderHistory.map((items, i) => (
      items.book ? (
        ...
        <div key={i} className="text-red-500 text-center">Order missing book details</div>
      )
    ))}
  </div>
)}
