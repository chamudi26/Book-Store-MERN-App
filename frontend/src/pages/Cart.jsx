...
const Cart = () => {
  ...
  {Cart && Cart.length === 0 && (
    <div className='h-screen'>
      <div className='h-[100%] flex items-center justify-center flex-col bg-zinc-700'>
      <img src='cart1.png' alt='' className='h-[20vh] my-2'/>
        <h1 className='text-5xl lg:text-2xl font-semibold text-zinc-800'>
          Empty Cart
        </h1>
  ...
  {Cart && Cart.length >0 &&(
    <div className='mt-4 w-full flex items-center justify-end'>
      <div className='p-4 bg-zinc-800 rounded'>
        ...
        <div className='mt-4 py-2  flex items-center justify-between text-xl text-zinc-200'>
          <h2>{Cart.length} books</h2><h2 className='px-8'>Rs. {Total}</h2>
        </div>
        <div className='w-[100%] mt-3'>
          <button className='bg-zinc-100 rounded px-4 py-2 flex justify-center w-fullfont-semibold hover:bg-zinc-500'
          onClick={PlaceOrder}>
            Place Your Order
          </button>
        </div>
